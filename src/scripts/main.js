...
document.onreadystatechange = () => {    
    if(document.readyState === "complete"){
        ...
        // Prevent clicking the parent menu button
        // let menuBtnA = document.querySelector('.menu-btn + a');
        // if(menuBtnA){
        //     menuBtnA.addEventListener('click',e=>{
        //         e.preventDefault();
        //     });
        // }
    ...
    //     var menuItems = document.querySelectorAll('#menu-wrapper li.has-submenu > a');
    //     Array.prototype.forEach.call(menuItems, function(el){
    //         toggleMenu = el.parentElement;
    ...
    //           if (toggleMenu.hasAttribute("data-expanded")) {
    //             console.log("Menu A Focus");
    //             toggleMenuState(toggleMenu);
    //             event.preventDefault();
    //             event.stopPropagation();
    //           }
    //         });
            
    //         // On Blue (Loss of Focus)
    //         el.querySelector('a').addEventListener("blur",  function(event){
    //           if (toggleMenu.hasAttribute("data-expanded")) {
    //             console.log("Menu A Blur");
    //             toggleMenuState(toggleMenu);
    //             event.preventDefault();
    //             event.stopPropagation();
    //           }
    ...
    //         function toggleMenuState(toggleMenu){
    //           if (toggleMenu.hasAttribute("data-expanded", "false")) {
    //             openMenu(toggleMenu);
    //           } else if (toggleMenu.hasAttribute("data-expanded", "true")) {
    //             closeMenu(toggleMenu);
    //           } else {
    //             openMenu(toggleMenu);
    //           }
    ...
    //           toggleMenu.setAttribute("data-expanded", "true");
    //           console.log("Menu's Data Expanded set to TRUE");
    //         }

    //         function closeMenu(toggleMenu){
    //           toggleMenu.setAttribute("data-expanded", "false");
    //           console.log("Menu's Data Expanded set to FALSE");
    //         }
    //     });
